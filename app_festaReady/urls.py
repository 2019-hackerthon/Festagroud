...
urlpatterns = [
    ...
    path('<int:festa_id>/<int:ticket_id>/create_commenttic/', views.create_commenttic, name="create_commenttic"),
    path('<int:festa_id>/delete_commenttic/<int:ticket_id>/<int:commenttic_id>', views.delete_commenttic, name="delete_commenttic"),
    ...
    path('<int:festa_id>/<int:ticket_id>/incorrect_commenttic', views.incorrect_commenttic, name="incorrect_commenttic"),
