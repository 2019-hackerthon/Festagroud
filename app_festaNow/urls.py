...
urlpatterns = [
    ...
    path('<int:festa_id>/staff/staff_main2', views.staff_main2, name="staff_main2"),
    ...
    path('<int:festa_id>/staff/edit_audience/<int:audience_id>/', views.edit_audience, name="edit_audience"),
